...
try {
    ...
    // ⚠️ ВАЖНО: Заменил 'tablic' на 'users' для соответствия остальной части проекта.
    ...
    error_log("DB Connection Error (edit_services.php): " . $e->getMessage());
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($message)) {
        if (file_put_contents($file_path, $content) !== false) {
            $message = '✅ Содержимое страницы «Услуги» успешно сохранено!';
            $messageType = 'success';
        } else {
...
$current_content = file_exists($file_path) ? file_get_contents($file_path) : '<h2>Наши услуги</h2><p>Описание услуг будет здесь...</p>';
?>
...
<head>
    ...
    <title>Редактировать "Услуги" | Админ-панель</title>
    <link rel="stylesheet" href="/style.css">
    <style>
        /* Стили для админской формы редактирования (единый стиль с edit_about.php) */
...
<main class="edit-container">
    <div class="edit-header">
        <h1>✏️ Редактирование страницы "Услуги"</h1>
        <a href="/services.php" target="_blank" style="color: #2563eb; text-decoration: none; font-size: 0.9rem;">👁️ Просмотреть на сайте</a>
    </div>
    ...
    <form method="POST">
        <div class="form-group">
            ...
            <textarea id="content" name="content" placeholder="<h2>Наши услуги</h2><p>Текст...</p>"><?= htmlspecialchars($current_content, ENT_QUOTES, 'UTF-8') ?></textarea>
